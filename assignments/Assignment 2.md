...
I would recommend using one of the same datasets from the last assignment.
...
Be sure to add this dataset to your .gitignore file

### Second: Create a Data Loader


Create a file in the src directory named dataloader.py.

# Question 3 (3 points)

## Write tests and format your code

In the tests directory create a file named “test_dataloader.py”.

Using  write as many tests as needed to show your Data Loader is working as intended.
