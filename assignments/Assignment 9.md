...
## Set up a service to return HTML structured output for an LLM

Hint, while you can use any model you want for this assignment, a larger model may be easier to work with.

Resources:
Book Section 7.3.2 and 7.4.1
 

Take a screenshot of a request and response with structured output add it to your PR.
# Question 3 (3 points)

## Write tests and format your code

Create a directory titled “tests”. In this directory create file “test_html.py”.
