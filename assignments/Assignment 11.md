...
## Create a frontend for your LLM application
...
Take a screenshot of a request and response from your user interface
# Question 3 (3 points)

## Write tests and format your code

Create a directory titled “tests”. In this directory create file “test_frontend.py”.

Using  write as many tests as needed to show your frontend is working as intended.
